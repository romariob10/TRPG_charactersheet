...
import { registerGameSystemRoutes } from "./modules/systems/routes.js";
import { registerSheetBuilderRoutes } from "./modules/sheet-builder/routes.js";
import { registerComponentRoutes } from "./modules/components/routes.js";
import { registerRepeaterRoutes } from "./modules/repeaters/routes.js";
...
export async function buildApp(options: BuildAppOptions): Promise<FastifyInstance> {
  ...
  await registerGameSystemRoutes(app);
  await registerSheetBuilderRoutes(app);
  await registerComponentRoutes(app);
  await registerRepeaterRoutes(app);
